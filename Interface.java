...
public class Interface {
  ...
  public boolean AKS_SIEMPRE;

  public double PASO1_TIME;
  public double PASO2_TIME;
  public double PASO3_TIME;
  public double PASO5_TIME;
  ...
  public boolean isPrime()
  {
    ...
    if(AKS_SIEMPRE)
    {
      ...
      PASO1_TIME = (AKSThread.PASO1_END - AKSThread.PASO1_START) / 1000.0;
      PASO2_TIME = (AKSThread.PASO2_END - AKSThread.PASO2_START) / 1000.0;
      PASO3_TIME = (AKSThread.PASO3_END - AKSThread.PASO3_START) / 1000.0;
      PASO5_TIME = (AKSThread.PASO5_END - AKSThread.PASO5_START) / 1000.0;
